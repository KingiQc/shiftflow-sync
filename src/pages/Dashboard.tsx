    ...
    <div className="space-y-5 animate-fade-in-up">
      ...
      <div className="glass-card p-5 animate-fade-in-up stagger-1">
        ...
        <div className="glass-card mt-4 p-4 grid grid-cols-3 gap-3 text-center">
          <div>
            <Icon icon="mdi:receipt-text" width={22} className="text-primary mx-auto mb-1" />
          ...
          <div>
            <Icon icon="mdi:briefcase-outline" width={22} className="text-primary mx-auto mb-1" />
          ...
          <div>
            <Icon icon="mdi:star-circle" width={22} className="text-primary mx-auto mb-1" />
      ...
      <div className="animate-fade-in-up stagger-2">
        <div className="flex items-center gap-2 mb-3">
          <Icon icon="mdi:calendar-today" width={22} className="text-foreground" />
          <div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="glass-card-glow p-4 text-center">
            <Icon icon="mdi:clock-outline" width={28} className="text-primary mx-auto mb-2" />
          ...
          <div className="glass-card-glow p-4 text-center">
            <Icon icon="mdi:chart-line" width={28} className="text-primary mx-auto mb-2" />
          ...
          <div className="glass-card-glow p-4 text-center">
            <Icon icon="mdi:heart" width={28} className="text-red-500 mx-auto mb-2" />
            <div className="text-xs text-muted-foreground">Health</div>
            <div className="font-semibold text-foreground">Ok</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 animate-fade-in-up stagger-3">
        <div className="glass-card-glow p-4">
          <div className="flex items-center gap-2 mb-2">
            <Icon icon="mdi:calendar-week" width={20} className="text-primary" />
        ...
        <div className="glass-card-glow p-4">
          <div className="flex items-center gap-2 mb-2">
            <Icon icon="mdi:calendar-month" width={20} className="text-primary" />
      ...
      <div className="glass-card p-4 animate-fade-in-up stagger-3">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-primary/15 flex items-center justify-center">
            <Icon icon="mdi:calendar-clock" width={20} className="text-primary" />
          </div>
      ...
      {/* FABs */}
      <div className="fixed bottom-20 md:bottom-8 right-4 md:right-8 z-30 flex flex-col gap-3">
        <button className="fab" onClick={() => navigate('/calendar')}>
          <Icon icon="mdi:calendar" width={24} className="text-foreground" />
        </button>
