  ...
  return (
    <div className="space-y-5 animate-fade-in-up">
      <div className="flex items-center gap-2">
        <Icon icon="mdi:lightbulb-on" width={24} className="text-primary" />
      ...
      {insights.length === 0 ? (
        ...
        <div className="space-y-3">
          {insights.map((ins, i) => (
            <div key={i} className="glass-card-glow p-4 flex items-start gap-4 animate-fade-in-up" style={{ animationDelay: `${i * 0.08}s` }}>
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: `${ins.color}20` }}>
                <Icon icon={ins.icon} width={22} style={{ color: ins.color }} />
              </div>
              <div>
